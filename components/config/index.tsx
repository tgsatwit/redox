// Config component exports
export { DocumentConfigManager } from "./document-config-manager";
export { DocumentTypeManager } from "./document-type-manager";
export { SubTypeManager } from "./subtype-manager";
export { DataElementManager } from "./data-element-manager";
